...
comments about issues like improper test placement or naming. Hence, we decided
to share it with others. We don't think our rules are the only good way to set
